...
//import com.fiap.hospital.bff.infra.adapter.gateway.GetGatewayImpl;
...
//import com.fiap.hospital.bff.infra.persistence.repository.UserRepositoryAdapter;
...
//
//        when(typeEntityRepository.findAll()).thenReturn(List.of(typeEntity));
...
//        Type typeDomain = new Type();
//
//        when(typeEntityRepository.findById(typeId)).thenReturn(Optional.of(typeEntity));
//        when(typeMapper.toTypeEntityDomain(typeEntity)).thenReturn(typeDomain);
//
...
//        Long typeId = 99L;
//        when(typeEntityRepository.findById(typeId)).thenReturn(Optional.empty());
//
