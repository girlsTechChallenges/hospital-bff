...
//import com.fiap.hospital.bff.infra.adapter.gateway.UpdateGatewayImpl;
...
//
//        updateGateway = new UpdateGatewayImpl(passwordEncoder, userRepository, typeEntityRepository, userMapper, typeMapper);
//    }
//
//    @Test
...
//        when(typeEntityRepository.findByNameType("ADMIN")).thenReturn(Optional.of(newTypeEntity));
...
//
//        when(typeEntityRepository.findById(idType)).thenReturn(Optional.empty());
//
...
//
//        when(typeEntityRepository.findById(idType)).thenReturn(Optional.of(existingTypeEntity));
//        when(typeEntityRepository.findByNameType(normalizedName)).thenReturn(Optional.of(conflictingTypeEntity));
//
...
//        when(typeEntityRepository.save(existingTypeEntity)).thenReturn(updatedTypeEntity);
