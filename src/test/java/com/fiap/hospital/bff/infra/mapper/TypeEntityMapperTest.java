...
class TypeEntityMapperTest {
    ...
    void toTypeEntityDomain_FromRequestDto_ShouldMapCorrectly() {
        TypeEntityRequestDto dto = new TypeEntityRequestDto("Admin", List.of("ROLE_ADMIN", "ROLE_USER"));
    ...
    void typeEntityResponse_FromType_ShouldMapCorrectly() {
        ...
        TypeEntityResponse response = mapper.typeEntityResponse(type);
    ...
    void typeEntityResponse_FromOptionalPresent_ShouldReturnResponse() {
        ...
        TypeEntityResponse response = mapper.typeEntityResponse(optional);
    ...
    void getTypeByIdToTypeResponseDto_Present_ShouldReturnResponse() {
        ...
        TypeEntityResponse response = mapper.getTypeByIdToTypeResponseDto(optional);
    ...
    void toTypeResponseDto_ShouldMapCorrectly() {
        ...
        TypeEntityResponse response = mapper.toTypeResponseDto(type);
