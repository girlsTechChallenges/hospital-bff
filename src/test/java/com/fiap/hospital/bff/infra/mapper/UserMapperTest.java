...
//        UserRequestDto userRequestDto = new UserRequestDto("João", "joao@email.com", "joaologin", "123456", new Type(null, "ADMIN", List.of("READ", "WRITE")));
//
//        User user = userMapper.toUserDomain(userRequestDto);
//
...
//
//        UserAuthRequestDto authDto = userMapper.toTokenResponseDto(token);
//
